...
class Theatre {
	...
	constructor() {
		if (!Theatre.instance) {
			...
			Theatre.ICONLIB = "modules/theatre-inserts/app/graphics/emotes"; 
			Theatre.DEBUG = false; 
	...
	_injectHTML() {
		...
		let btnClearStage = document.createElement("a"); 
		let iconClearStage = document.createElement("i"); 

		KHelpers.addClass(this.theatreControls,"theatre-control-group"); 
		KHelpers.addClass(this.theatreNavBar,"theatre-control-nav-bar");
		this.theatreNavBar.setAttribute("title", game.i18n.localize("Theatre.UI.Title.NavBar"));
		...
		KHelpers.addClass(btnClearStage,"button"); 
		KHelpers.addClass(iconClearStage,"fas"); 
		KHelpers.addClass(iconClearStage,"fa-times"); 
		...
		btnClearStage.addEventListener("click", this.handleBtnDelayEmoteClick); 
	 ...
	 */
	_initFaceAPI() {
		const MODEL_URL = "modules/theatre-inserts/app/weights"; 
	...
	_createPortraitPIXIContainer(imgPath,portName,imgId,optAlign,emotions,isLeft) {
		...
		imgSrcs.push({imgpath: "modules/theatre-inserts/app/graphics/typing.png", resname: "modules/theatre-inserts/app/graphics/typing.png"}); 
	...
	_setupPortraitContainer(imgId,optAlign,resName,resources,reorder) {
		...
		let maxHeight = (this.theatreDock.height * .9) - (optAlign == "top" ? this.theatreBar.offsetHeight : 0);

		let portWidth =  resources[resName].texture.width; 
		let portHeight =  resources[resName].texture.height;

		if (portHeight > maxHeight) {
			let scale = maxHeight / portHeight;
			if (Theatre.DEBUG) console.log("Image is too tall, scaling by " + scale); 
			portHeight *= scale;
			portWidth *= scale;
		}
		...
		if (!insert.typingBubble) {
			...
			typingBubble.texture = resources["modules/theatre-inserts/app/graphics/typing.png"].texture; 
	...
	renderEmoteMenu() {
		...
		renderTemplate("modules/theatre-inserts/app/templates/emote_menu.html",{emotes,textFlyin,textStanding,fonts}).then(template=>{
	...
	static getDefaultRiggingResources() {
		return [
			// bubbles
			{name: "angry", path: "modules/theatre-inserts/app/graphics/bubbles/angry.png"},
			{name: "frustrated", path: "modules/theatre-inserts/app/graphics/bubbles/frustrated.png"},
			{name: "annoyed", path: "modules/theatre-inserts/app/graphics/bubbles/annoyed.png"},
			{name: "hearts", path: "modules/theatre-inserts/app/graphics/bubbles/hearts.png"},
			{name: "sleeping", path: "modules/theatre-inserts/app/graphics/bubbles/sleeping.png"},
			{name: "surprised", path: "modules/theatre-inserts/app/graphics/bubbles/surprised.png"},
			{name: "confused", path: "modules/theatre-inserts/app/graphics/bubbles/confused.png"},
			{name: "awe-struck", path: "modules/theatre-inserts/app/graphics/bubbles/awe-struck.png"},
			{name: "kiss", path: "modules/theatre-inserts/app/graphics/bubbles/kiss.png"},
			{name: "blushing", path: "modules/theatre-inserts/app/graphics/bubbles/blushing.png"},
			{name: "cry", path: "modules/theatre-inserts/app/graphics/bubbles/cry.png"},
			{name: "dissatisfied", path: "modules/theatre-inserts/app/graphics/bubbles/dissatisfied.png"},
			{name: "dizzy", path: "modules/theatre-inserts/app/graphics/bubbles/dizzy.png"},
			{name: "evil", path: "modules/theatre-inserts/app/graphics/bubbles/evil.png"},
			{name: "frown", path: "modules/theatre-inserts/app/graphics/bubbles/frown.png"},
			{name: "happy", path: "modules/theatre-inserts/app/graphics/bubbles/happy.png"},
			{name: "grin", path: "modules/theatre-inserts/app/graphics/bubbles/grin.png"},
			{name: "happytears", path: "modules/theatre-inserts/app/graphics/bubbles/happytears.png"},
			{name: "laughing", path: "modules/theatre-inserts/app/graphics/bubbles/laughing.png"},
			{name: "laughingsquint", path: "modules/theatre-inserts/app/graphics/bubbles/laughingsquint.png"},
			{name: "meh", path: "modules/theatre-inserts/app/graphics/bubbles/meh.png"},
			{name: "worried", path: "modules/theatre-inserts/app/graphics/bubbles/worried.png"},
			{name: "panic", path: "modules/theatre-inserts/app/graphics/bubbles/panic.png"},
			{name: "rofl", path: "modules/theatre-inserts/app/graphics/bubbles/rofl.png"},
			{name: "sad", path: "modules/theatre-inserts/app/graphics/bubbles/sad.png"},
			{name: "scared", path: "modules/theatre-inserts/app/graphics/bubbles/scared.png"},
			{name: "smile", path: "modules/theatre-inserts/app/graphics/bubbles/smile.png"},
			{name: "playful", path: "modules/theatre-inserts/app/graphics/bubbles/playful.png"},
			{name: "smug", path: "modules/theatre-inserts/app/graphics/bubbles/smug.png"},
			{name: "tongue", path: "modules/theatre-inserts/app/graphics/bubbles/tongue.png"},
			{name: "wink", path: "modules/theatre-inserts/app/graphics/bubbles/wink.png"},
			{name: "speechless", path: "modules/theatre-inserts/app/graphics/bubbles/speechless.png"},
			{name: "thinking", path: "modules/theatre-inserts/app/graphics/bubbles/thinking.png"},
			{name: "idea", path: "modules/theatre-inserts/app/graphics/bubbles/idea.png"},
			{name: "serious", path: "modules/theatre-inserts/app/graphics/bubbles/serious.png"},
			{name: "innocent", path: "modules/theatre-inserts/app/graphics/bubbles/innocent.png"},
			{name: "carefree", path: "modules/theatre-inserts/app/graphics/bubbles/carefree.png"},

			// effects
			{name: "swirl", path: "modules/theatre-inserts/app/graphics/effects/swirl.png"},
			{name: "sweatdrop", path: "modules/theatre-inserts/app/graphics/effects/sweatdrop.png"},
			{name: "notice", path: "modules/theatre-inserts/app/graphics/effects/notice.png"},
			{name: "loud", path: "modules/theatre-inserts/app/graphics/effects/loud.png"},
			{name: "semiloud", path: "modules/theatre-inserts/app/graphics/effects/semi-loud.png"},
			{name: "veins", path: "modules/theatre-inserts/app/graphics/effects/veins.png"},
			{name: "veins_red", path: "modules/theatre-inserts/app/graphics/effects/veins_red.png"},
			{name: "twisty", path: "modules/theatre-inserts/app/graphics/effects/twisty.png"},
			{name: "glimmer", path: "modules/theatre-inserts/app/graphics/effects/glimmer.png"},
			{name: "heart", path: "modules/theatre-inserts/app/graphics/effects/heart.png"},
			{name: "puff", path: "modules/theatre-inserts/app/graphics/effects/puff.png"},
			{name: "line", path: "modules/theatre-inserts/app/graphics/effects/line.png"},
			{name: "linesteep", path: "modules/theatre-inserts/app/graphics/effects/line_steep.png"},
			{name: "star", path: "modules/theatre-inserts/app/graphics/effects/star.png"},
			{name: "musicnote", path: "modules/theatre-inserts/app/graphics/effects/musicnote.png"},
			//{name: "ghostball", path: "modules/theatre-inserts/app/graphics/effects/ghostball.png"},
			{name: "ghostball1", path: "modules/theatre-inserts/app/graphics/effects/ghostball1.png"},
			{name: "ghostball2", path: "modules/theatre-inserts/app/graphics/effects/ghostball2.png"},
			{name: "scribbleball", path: "modules/theatre-inserts/app/graphics/effects/scribbleball.png"},
			{name: "thoughtbubble", path: "modules/theatre-inserts/app/graphics/effects/thoughtbubble.png"},
			{name: "bubbledot", path: "modules/theatre-inserts/app/graphics/effects/bubbledot.png"},
			{name: "dot", path: "modules/theatre-inserts/app/graphics/effects/dot.png"},
			{name: "ziggy", path: "modules/theatre-inserts/app/graphics/effects/ziggy.png"},
			{name: "sinking", path: "modules/theatre-inserts/app/graphics/effects/sinking.png"},
			{name: "zzz", path: "modules/theatre-inserts/app/graphics/effects/zzz.png"},
			{name: "lightbulb", path: "modules/theatre-inserts/app/graphics/effects/lightbulb.png"},
			{name: "sigh", path: "modules/theatre-inserts/app/graphics/effects/sigh.png"},
			{name: "halo", path: "modules/theatre-inserts/app/graphics/effects/halo.png"},
			{name: "blush", path: "modules/theatre-inserts/app/graphics/effects/blush.png"},
			{name: "miasma", path: "modules/theatre-inserts/app/graphics/effects/miasma.png"},
			{name: "darkness", path: "modules/theatre-inserts/app/graphics/effects/darkness.png"},
			{name: "tears", path: "modules/theatre-inserts/app/graphics/effects/tears.png"}
		]; 
	}
	...
	static getDefaultEmotes() {
		return {
			...
			"serious": {
				...
				image: "modules/theatre-inserts/app/graphics/emotes/serious.png",
			...
			"frustrated": {
				...
				fatype:"far",
				faname:"fa-meh-rolling-eyes",
				image: "modules/theatre-inserts/app/graphics/emotes/frustrated.png",
			...
			"thinking": {
				...
				fatype:"far",
				faname:"fa-blank",
				image: "modules/theatre-inserts/app/graphics/emotes/thinking.png",
			...
			"confused": {
				...
				image: "modules/theatre-inserts/app/graphics/emotes/confused.png",
			...
			"idea": {
				...
				fatype:"far",
				faname:"fa-lightbulb",
				image: "modules/theatre-inserts/app/graphics/emotes/idea.png",
			...
			"smug": {
				...
				image: "modules/theatre-inserts/app/graphics/emotes/smug.png",
			...
			"mischevious": {
				...
				fatype:"fas",
				faname:"fa-book-dead",
				image: "modules/theatre-inserts/app/graphics/emotes/evil.png",
			...
			"innocent": {
				...
				fatype:"fas",
				faname:"fa-book-dead",
				image: "modules/theatre-inserts/app/graphics/emotes/innocent.png",
			...
			"carefree": {
				...
				fatype:"fas",
				faname:"fa-book-dead",
				image: "modules/theatre-inserts/app/graphics/emotes/carefree.png",
			...
			"speechless": {
				...
				image: "modules/theatre-inserts/app/graphics/emotes/speechless.png",
			...
			"sleeping": {
				...
				fatype:"fas",
				faname:"fa-bed",
				image: "modules/theatre-inserts/app/graphics/emotes/sleeping.png",
